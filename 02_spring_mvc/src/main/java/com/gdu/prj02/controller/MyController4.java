...
public class MyController4 {
  ...
  public String add(BlogDto blog) {   // 커맨드 객체의 Model 저장 방식 : 클래스 타입을 CamelCase로 변경해서 저장한다. (BlogDto - blogDto 로 변경 저장)
    // blog/addResult.jsp 로 forward
    return "blog/addResult";
  }
  
  @RequestMapping(value="/blog/add.do", method = RequestMethod.POST)
  public String add2(@ModelAttribute("blog") BlogDto blog) {    // @ModelAttribute : 커맨드 객체가 Model 에 저장되는 이름을 지정할 때 사용.
    return "blog/addResult";
  }
