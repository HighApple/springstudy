...
public class MemberServiceImpl implements MemberService {
  ...
  public ResponseEntity<Map<String, Object>> registerMember(Map<String, Object> map, HttpServletResponse response) {
    ...
    try {
      ...
      int insertCount = memberDao.insertMember(member); // 여기서 memberNo 에 저장
      ...
      result = new ResponseEntity<Map<String,Object>>(Map.of("insertCount", insertCount),
                                                      HttpStatus.OK);
      
    } catch (DuplicateKeyException e) { // catch(Exception e) {e.getClass().getName() } exception 이름을 알수있다
